                                ...
                                <div className="col p-4 d-flex flex-column position-static">
                                    ...
                                    <div className="row">
                                        <div className="col-sm">
                                            <a href="#" onClick={handleGoDetail} className="stretched-link">상세</a>
                                        </div>
                                        <div className="col-sm">
                                            <button type="button" onClick={handleGoModal} className="btn btn-primary">상세보기</button>
                                        </div>
                                    </div>
                                </div>
